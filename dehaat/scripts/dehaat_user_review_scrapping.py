...
application_id = 'app.intspvt.com.farmer' # set application ID
language = 'en' # set language
country = 'us' # set country
milliseconds = 10000 # set milliseconds
...
# set excel file path
excel_file_path = '/home/yagnikposhiya/WorkStation/Lab/playstore-app-reviews/dehaat/reviews/dehaat_reviews_1.xlsx'
