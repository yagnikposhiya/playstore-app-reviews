...
application_id = 'com.ulink.agrostar' # set application ID
...
# set excel file path
excel_file_path = '/home/yagnikposhiya/WorkStation/Lab/playstore-app-reviews/agrostar/reviews/agrostar_reviews_1.xlsx'
