...
application_id = 'com.criyagen' # set application ID
...
# set excel file path
excel_file_path = '/home/yagnikposhiya/WorkStation/Lab/playstore-app-reviews/agriapp/reviews/agriapp_reviews_1.xlsx'
