...
application_id = 'in.gov.enam' # set application ID
...
# set excel file path
excel_file_path = '/home/yagnikposhiya/WorkStation/Lab/playstore-app-reviews/e-NAM/reviews/enam_reviews_1.xlsx'
